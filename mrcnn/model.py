...
############################################################
'''
from cutmix-keras import CutMixImageDataGenerato
...
def log2_graph(x):
    ...
    return tf.math.log(x) / tf.math.log(2.0)#tf.log
...
def refine_detections_graph(rois, probs, deltas, window, config):
    ...
    if config.DETECTION_MIN_CONFIDENCE:
        ...
        keep = tf.sets.intersection(tf.expand_dims(keep, 0),
                                        tf.expand_dims(conf_keep, 0))#set_intersection
    ...
    keep = tf.sets.intersection(tf.expand_dims(keep, 0),
                                    tf.expand_dims(nms_keep, 0))#tf.sets.set_intersection
    keep = tf.sparse.to_dense(keep)[0]#keep = tf.sparse_tensor_to_dense(keep)[0]
    # Keep top detections
...
class MaskRCNN():
    ...
    def set_log_dir(self, model_path=None):
        ...
        #checkpoint_path='./checkpoint_save/model.{epoch:02d}-{val_loss:.4f}.h5'
    ...
    def train(self, train_dataset, val_dataset, learning_rate, epochs, layers,
        ...
        ## custom, loss and val_loss visuzllize
        try:
            a = history.epoch
...
############################################################
#  Custom, loss and val_loss visuallize
############################################################
